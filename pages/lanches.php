...
$PAGE_DESC   = 'Receitas práticas e saborosas para lanches e petiscos';
$PAGE_STYLES = [
...
<main class="buscar-main">
    <div class="container">
        ...
        <section class="categoria-header">
            <div class="categoria-banner lanches">
                <div class="categoria-banner-imagem">
                    <img src="/Story-Bytes-/img/lanches.jpg" alt="Lanches saborosos">
                </div>
                <div class="categoria-banner-conteudo">
                    <h1 class="categoria-banner-titulo">Lanches</h1>
                    <p class="categoria-banner-descricao">Ideias práticas e deliciosas para seus lanches</p>
                ...
                <?php while($receita = $receitas->fetch_assoc()): ?>
                    <article class="receita-card">
                        ...
                        <div class="receita-card-body">
                            ...
                            <?php else: ?>
                                <!-- Imagem padrão para lanches -->
                                <div class="receita-imagem">
                                    <img src="/Story-Bytes-/img/lanches.jpg" 
                                         alt="<?= htmlspecialchars($receita['titulo']) ?>">
                                </div>
                            <?php endif; ?>
        ...
        <?php else: ?>
            <div class="sem-resultados">
                <h3>Nenhuma receita de lanches encontrada</h3>
