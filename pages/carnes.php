...
// Primeiro, contar o total de receitas da categoria Carnes
...
<main class="buscar-main">
    <div class="container">
        ...
        <section class="categoria-header">
            <div class="categoria-banner carnes">
                <div class="categoria-banner-imagem">
                    <img src="/Story-Bytes-/img/carnes.jpg" alt="Pratos com carne">
                </div>
                <div class="categoria-banner-conteudo">
                    <h1 class="categoria-banner-titulo">Carnes</h1>
                    <p class="categoria-banner-descricao">Descubra receitas saborosas com carnes para todas as ocasiões</p>
                    ...
                    <article class="receita-card">
                        ...
                        <div class="receita-card-body">
                            ...
                            <?php else: ?>
                                ...
                                <div class="receita-imagem">
                                    <img src="/Story-Bytes-/img/carnes.jpg" 
                                         alt="<?= htmlspecialchars($receita['titulo']) ?>">
                                </div>
                            <?php endif; ?>
