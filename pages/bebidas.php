...
<main class="buscar-main">
    <div class="container">
        ...
        <section class="categoria-header">
            <div class="categoria-banner bebidas">
                <div class="categoria-banner-imagem">
                    <img src="/Story-Bytes-/img/bebidas.jpg" alt="Bebidas refrescantes">
                </div>
                <div class="categoria-banner-conteudo">
                    <h1 class="categoria-banner-titulo">Bebidas</h1>
                    <p class="categoria-banner-descricao">Descubra receitas de bebidas refrescantes para se refrescar</p>
