...
// Primeiro, contar o total de receitas da categoria Massas
...
<main class="buscar-main categoria-massas">
    <div class="container">
        <!-- Cabeçalho da categoria -->
        <section class="categoria-header">
            <div class="categoria-banner massas">
                <div class="categoria-banner-imagem">
                    <img src="/Story-Bytes-/img/massas.jpg" alt="Pratos de massa">
                </div>
                <div class="categoria-banner-conteudo">
                    <h1 class="categoria-banner-titulo">Massas</h1>
                    <p class="categoria-banner-descricao">Pratos de massa reconfortantes e cheios de sabor</p>
                    ...
                    <article class="receita-card">
                        ...
                        <div class="receita-card-body">
                            ...
                            <?php else: ?>
                                ...
                                <div class="receita-imagem">
                                    <img src="/Story-Bytes-/img/massas.jpg" 
                                         alt="<?= htmlspecialchars($receita['titulo']) ?>">
                                </div>
                            <?php endif; ?>
