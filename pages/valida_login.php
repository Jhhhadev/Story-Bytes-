    ...
    if (password_verify($senha, $usuario['senha'])) {
        ...
        <main class="formulario">
            <div class="mensagem-erro">
                ...
                <a href="/Story-Bytes-/pages/login.php" class="link-simples">Tentar novamente</a>
            </div>
            <script>
    ...
    <main class="formulario">
        <div class="mensagem-erro">
            ...
            <div class="acoes-container">
                <a href="/Story-Bytes-/pages/login.php" class="link-acao secundario">Tentar novamente</a>
                <a href="/Story-Bytes-/pages/cadastro.php" class="link-acao primario">Criar conta</a>
            </div>
        </div>
    </main>';
}
